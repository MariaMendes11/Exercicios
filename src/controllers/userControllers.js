...
module.exports = class userController {
  ...
  static async updateUser(req, res) {
    ...
    if(!cpf || !email || !password || !name){
     ...
     //Proucurar o Indice do user no Array 'users' pelo cpf
    ...
    //Atualiza os dados do usuario Array 'users'
  ...
  //Removendo o usuario array 'users' 
  users.splice(userIndex,1);

  return res.status(200).json({message:"Úsuario Apagado"})
